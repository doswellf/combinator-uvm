...
public :
  ...
  bool check_data(unsigned int base, PAYLOAD_TYPE* gp);
...
public :
  ...
  void start_of_simulation() {
      cout << "top::start_of_simulation" << endl;
  }

  void end_of_elaboration() { 
      cout << "top::end_of_elaboration" << endl;
  }

  void before_end_of_elaboration() { 
      cout << "top::before_end_of_elaboration" << endl;
  }
