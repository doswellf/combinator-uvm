...
public:
			 ...
			 , cons("consumer")
  {
    ...
    svtop = uvm_ml_create_component("SV", "test", "test1", this);
  }
  void before_end_of_elaboration() {
...
public:
  ...
  void connect() { 
    ...
    uvm_ml_connect("sctop.sc_env.test1.sv_env.producer.aport", sc_env.cons.aexport.name());
    uvm_ml_connect(sc_env.prod.aport.name(), "sctop.sc_env.test1.sv_env.consumer.aimp");
  }
  void start_of_simulation() { 
