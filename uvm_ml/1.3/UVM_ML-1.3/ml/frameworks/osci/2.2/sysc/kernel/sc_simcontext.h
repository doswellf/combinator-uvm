...
public:
    ...
    void do_simulate(const sc_time& );
    void co_simulate(const sc_time& );
    void quasi_static_start_of_construction();
    void quasi_static_end_of_construction();
    void quasi_static_connect();
    void quasi_static_complete_binding();
    void quasi_static_end_of_elaboration();

    bool quasi_static_elaboration_done() const;

    void quasi_static_start_of_simulation();
    void quasi_static_prepare_to_simulate();

    bool check_stop();
    void quasi_static_module_construction_done(sc_module * node);
    void quasi_static_module_end_of_elaboration(sc_module * node);
    void quasi_static_module_start_of_simulation(sc_module * node);

    bool signal_end_of_elaboration();
    bool signal_start_of_simulation();

    std::vector<sc_module *> & subtree_get_modules(sc_module * mod);
...
inline 
bool 
sc_simcontext::quasi_static_elaboration_done() const 
{ 
    return elaboration_done();
}
...
sc_get_curr_process()
{
    return sc_get_current_process_b();
}
