 ...
 */
  ...
  *                + uvmsc_boost::RegEx high level wrapper.
  */

#ifndef UVMSC_BOOST_RE_CREGEX_HPP_INCLUDED
#define UVMSC_BOOST_RE_CREGEX_HPP_INCLUDED
...
#if defined(__cplusplus) && !defined(UVMSC_BOOST_NO_STDC_NAMESPACE)
...
UVMSC_BOOST_REGEX_DECL int UVMSC_BOOST_REGEX_CCALL regcompA(regex_tA*, const char*, int);
UVMSC_BOOST_REGEX_DECL regsize_t UVMSC_BOOST_REGEX_CCALL regerrorA(int, const regex_tA*, char*, regsize_t);
UVMSC_BOOST_REGEX_DECL int UVMSC_BOOST_REGEX_CCALL regexecA(const regex_tA*, const char*, regsize_t, regmatch_t*, int);
UVMSC_BOOST_REGEX_DECL void UVMSC_BOOST_REGEX_CCALL regfreeA(regex_tA*);

#ifndef UVMSC_BOOST_NO_WREGEX
UVMSC_BOOST_REGEX_DECL int UVMSC_BOOST_REGEX_CCALL regcompW(regex_tW*, const wchar_t*, int);
UVMSC_BOOST_REGEX_DECL regsize_t UVMSC_BOOST_REGEX_CCALL regerrorW(int, const regex_tW*, wchar_t*, regsize_t);
UVMSC_BOOST_REGEX_DECL int UVMSC_BOOST_REGEX_CCALL regexecW(const regex_tW*, const wchar_t*, regsize_t, regmatch_t*, int);
UVMSC_BOOST_REGEX_DECL void UVMSC_BOOST_REGEX_CCALL regfreeW(regex_tW*);
#endif
...
class UVMSC_BOOST_REGEX_DECL RegEx
{
private:
