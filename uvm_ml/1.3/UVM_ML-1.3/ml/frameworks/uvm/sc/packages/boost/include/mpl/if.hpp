...
#ifndef UVMSC_BOOST_MPL_IF_HPP_INCLUDED
#define UVMSC_BOOST_MPL_IF_HPP_INCLUDED
...
#include <packages/boost/include/mpl/aux_/value_wknd.hpp>
...
template<
      typename UVMSC_BOOST_MPL_AUX_NA_PARAM(T1)
    , typename UVMSC_BOOST_MPL_AUX_NA_PARAM(T2)
    , typename UVMSC_BOOST_MPL_AUX_NA_PARAM(T3)
    >
struct if_
{
 private:
    ...
    typedef if_c<
          ...
          UVMSC_BOOST_MPL_AUX_VALUE_WKND(T1)::value
#else
          UVMSC_BOOST_MPL_AUX_STATIC_CAST(bool, UVMSC_BOOST_MPL_AUX_VALUE_WKND(T1)::value)
#endif
        , T2
        , T3
        > almost_type_;
 ...
 public:
    ...
    UVMSC_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,if_,(T1,T2,T3))
};
...
template<
      typename UVMSC_BOOST_MPL_AUX_NA_PARAM(C_)
    , typename UVMSC_BOOST_MPL_AUX_NA_PARAM(T1)
    , typename UVMSC_BOOST_MPL_AUX_NA_PARAM(T2)
    >
struct if_
{
    enum { msvc_wknd_ = UVMSC_BOOST_MPL_AUX_MSVC_VALUE_WKND(C_)::value };

    typedef typename aux::if_impl< UVMSC_BOOST_MPL_AUX_STATIC_CAST(bool, msvc_wknd_) >
        ::template result_<T1,T2>::type type;

    UVMSC_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,if_,(C_,T1,T2))
};

#endif // UVMSC_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION

UVMSC_BOOST_MPL_AUX_NA_SPEC(3, if_)

}}

#endif // UVMSC_BOOST_MPL_IF_HPP_INCLUDED
