...
#ifndef UVMSC_BOOST_MPL_VOID_FWD_HPP_INCLUDED
#define UVMSC_BOOST_MPL_VOID_FWD_HPP_INCLUDED
...
UVMSC_BOOST_MPL_AUX_ADL_BARRIER_DECL(void_)

#endif // UVMSC_BOOST_MPL_VOID_FWD_HPP_INCLUDED
