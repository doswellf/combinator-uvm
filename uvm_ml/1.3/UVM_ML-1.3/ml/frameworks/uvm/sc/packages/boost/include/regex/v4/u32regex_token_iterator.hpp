...
#ifndef UVMSC_BOOST_REGEX_V4_U32REGEX_TOKEN_ITERATOR_HPP
#define UVMSC_BOOST_REGEX_V4_U32REGEX_TOKEN_ITERATOR_HPP
...
#elif (UVMSC_BOOST_WORKAROUND(__BORLANDC__, >= 0x560) && UVMSC_BOOST_WORKAROUND(__BORLANDC__, UVMSC_BOOST_TESTED_AT(0x570)))\
      || UVMSC_BOOST_WORKAROUND(UVMSC_BOOST_MSVC, < 1300) \
      || UVMSC_BOOST_WORKAROUND(__MWERKS__, UVMSC_BOOST_TESTED_AT(0x3003)) \
