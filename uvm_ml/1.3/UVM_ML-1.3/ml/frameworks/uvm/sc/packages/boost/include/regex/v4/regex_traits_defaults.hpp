...
#define UVMSC_BOOST_REGEX_TRAITS_DEFAULTS_HPP_INCLUDED
...
UVMSC_BOOST_REGEX_DECL const char* UVMSC_BOOST_REGEX_CALL get_default_syntax(regex_constants::syntax_type n);
UVMSC_BOOST_REGEX_DECL const char* UVMSC_BOOST_REGEX_CALL get_default_error_string(regex_constants::error_type n);
UVMSC_BOOST_REGEX_DECL regex_constants::syntax_type UVMSC_BOOST_REGEX_CALL get_default_syntax_type(char c);
UVMSC_BOOST_REGEX_DECL regex_constants::escape_syntax_type UVMSC_BOOST_REGEX_CALL get_default_escape_syntax_type(char c);

// is charT c a combining character?
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL is_combining_implementation(uint_least16_t s);
...
#elif !defined(__DECCXX) && !defined(__osf__) && !defined(__OSF__) && defined(WCHAR_MIN) && (WCHAR_MIN == 0) && !defined(UVMSC_BOOST_NO_INTRINSIC_WCHAR_T)
...
{
   return UVMSC_BOOST_REGEX_MAKE_BOOL(
      (c == static_cast<charT>('\n')) 
      || (c == static_cast<charT>('\r')) 
      || (c == static_cast<charT>('\f')) 
      || (static_cast<uvmsc_boost::uint16_t>(c) == 0x2028u) 
      || (static_cast<uvmsc_boost::uint16_t>(c) == 0x2029u) 
      || (static_cast<uvmsc_boost::uint16_t>(c) == 0x85u));
}
template <>
inline bool is_separator<char>(char c)
{
   return UVMSC_BOOST_REGEX_MAKE_BOOL((c == '\n') || (c == '\r') || (c == '\f'));
}

//
// get a default collating element:
//
UVMSC_BOOST_REGEX_DECL std::string UVMSC_BOOST_REGEX_CALL lookup_default_collate_name(const std::string& name);
...
#endif
template <class charT>
inline charT UVMSC_BOOST_REGEX_CALL global_lower(charT c)
{
   return c;
}
template <class charT>
inline charT UVMSC_BOOST_REGEX_CALL global_upper(charT c)
{
   return c;
}

UVMSC_BOOST_REGEX_DECL char UVMSC_BOOST_REGEX_CALL do_global_lower(char c);
UVMSC_BOOST_REGEX_DECL char UVMSC_BOOST_REGEX_CALL do_global_upper(char c);
#ifndef UVMSC_BOOST_NO_WREGEX
UVMSC_BOOST_REGEX_DECL wchar_t UVMSC_BOOST_REGEX_CALL do_global_lower(wchar_t c);
UVMSC_BOOST_REGEX_DECL wchar_t UVMSC_BOOST_REGEX_CALL do_global_upper(wchar_t c);
#endif
#ifdef UVMSC_BOOST_REGEX_HAS_OTHER_WCHAR_T
UVMSC_BOOST_REGEX_DECL unsigned short UVMSC_BOOST_REGEX_CALL do_global_lower(unsigned short c);
UVMSC_BOOST_REGEX_DECL unsigned short UVMSC_BOOST_REGEX_CALL do_global_upper(unsigned short c);
#endif
//
...
//
template<> inline char UVMSC_BOOST_REGEX_CALL global_lower<char>(char c){ return do_global_lower(c); }
template<> inline char UVMSC_BOOST_REGEX_CALL global_upper<char>(char c){ return do_global_upper(c); }
#ifndef UVMSC_BOOST_NO_WREGEX
template<> inline wchar_t UVMSC_BOOST_REGEX_CALL global_lower<wchar_t>(wchar_t c){ return do_global_lower(c); }
template<> inline wchar_t UVMSC_BOOST_REGEX_CALL global_upper<wchar_t>(wchar_t c){ return do_global_upper(c); }
#endif
#ifdef UVMSC_BOOST_REGEX_HAS_OTHER_WCHAR_T
template<> inline unsigned short UVMSC_BOOST_REGEX_CALL global_lower<unsigned short>(unsigned short c){ return do_global_lower(c); }
template<> inline unsigned short UVMSC_BOOST_REGEX_CALL global_upper<unsigned short>(unsigned short c){ return do_global_upper(c); }
#endif
