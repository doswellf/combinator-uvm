...
#if defined(UVMSC_BOOST_NO_STDC_NAMESPACE)
namespace std{
   using ::wcstol;
}
#endif
...
c_regex_traits<wchar_t>::string_type UVMSC_BOOST_REGEX_CALL c_regex_traits<wchar_t>::transform(const wchar_t* p1, const wchar_t* p2) 
{ 
   std::size_t r;
   std::size_t s = 10;
...
c_regex_traits<wchar_t>::string_type UVMSC_BOOST_REGEX_CALL c_regex_traits<wchar_t>::transform_primary(const wchar_t* p1, const wchar_t* p2) 
{
   static wchar_t s_delim;
   static const int s_collate_type = ::uvmsc_boost::re_detail::find_sort_syntax(static_cast<const c_regex_traits<wchar_t>*>(0), &s_delim);
   std::wstring result;
   //
   ...
   {
   case ::uvmsc_boost::re_detail::sort_C:
   case ::uvmsc_boost::re_detail::sort_unknown:
   ...
   case ::uvmsc_boost::re_detail::sort_fixed:
      {
   ...
   case ::uvmsc_boost::re_detail::sort_delim:
...
c_regex_traits<wchar_t>::char_class_type UVMSC_BOOST_REGEX_CALL c_regex_traits<wchar_t>::lookup_classname(const wchar_t* p1, const wchar_t* p2) 
{
   ...
   int idx = ::uvmsc_boost::re_detail::get_default_class_id(p1, p2);
   if(idx < 0)
   {
      std::wstring s(p1, p2);
      for(std::wstring::size_type i = 0; i < s.size(); ++i)
         s[i] = (std::towlower)(s[i]);
      idx = ::uvmsc_boost::re_detail::get_default_class_id(&*s.begin(), &*s.begin() + s.size());
   }
   UVMSC_BOOST_ASSERT(idx+1 < static_cast<int>(sizeof(masks) / sizeof(masks[0])));
   return masks[idx+1];
}

bool UVMSC_BOOST_REGEX_CALL c_regex_traits<wchar_t>::isctype(wchar_t c, char_class_type mask) 
{
   return
      ...
      || ((mask & char_class_blank) && (std::iswspace)(c) && !::uvmsc_boost::re_detail::is_separator(c))
      || ((mask & char_class_word) && (c == '_'))
      || ((mask & char_class_unicode) && (c & ~static_cast<wchar_t>(0xff)))
      || ((mask & char_class_vertical) && (::uvmsc_boost::re_detail::is_separator(c) || (c == L'\v')))
      || ((mask & char_class_horizontal) && (std::iswspace)(c) && !::uvmsc_boost::re_detail::is_separator(c) && (c != L'\v'));
}

c_regex_traits<wchar_t>::string_type UVMSC_BOOST_REGEX_CALL c_regex_traits<wchar_t>::lookup_collatename(const wchar_t* p1, const wchar_t* p2) 
{
...
#endif
   name = ::uvmsc_boost::re_detail::lookup_default_collate_name(name);
#if !defined(UVMSC_BOOST_NO_TEMPLATED_ITERATOR_CONSTRUCTORS)\
               && !UVMSC_BOOST_WORKAROUND(UVMSC_BOOST_MSVC, < 1300)\
               && !UVMSC_BOOST_WORKAROUND(__BORLANDC__, <= 0x0551)
   if(name.size())
...
int UVMSC_BOOST_REGEX_CALL c_regex_traits<wchar_t>::value(wchar_t c, int radix) 
{
#ifdef __BORLANDC__
...
c_regex_traits<unsigned short>::string_type UVMSC_BOOST_REGEX_CALL c_regex_traits<unsigned short>::transform(const unsigned short* p1, const unsigned short* p2)
{
...
c_regex_traits<unsigned short>::string_type UVMSC_BOOST_REGEX_CALL c_regex_traits<unsigned short>::transform_primary(const unsigned short* p1, const unsigned short* p2)
{
   std::wstring result = c_regex_traits<wchar_t>::transform_primary((const wchar_t*)p1, (const wchar_t*)p2);
   return string_type(result.begin(), result.end());
}

c_regex_traits<unsigned short>::char_class_type UVMSC_BOOST_REGEX_CALL c_regex_traits<unsigned short>::lookup_classname(const unsigned short* p1, const unsigned short* p2)
{
   return c_regex_traits<wchar_t>::lookup_classname((const wchar_t*)p1, (const wchar_t*)p2);
}

c_regex_traits<unsigned short>::string_type UVMSC_BOOST_REGEX_CALL c_regex_traits<unsigned short>::lookup_collatename(const unsigned short* p1, const unsigned short* p2)
{
   std::wstring result = c_regex_traits<wchar_t>::lookup_collatename((const wchar_t*)p1, (const wchar_t*)p2);
   return string_type(result.begin(), result.end());
}

bool UVMSC_BOOST_REGEX_CALL c_regex_traits<unsigned short>::isctype(unsigned short c, char_class_type m)
{
   return c_regex_traits<wchar_t>::isctype(c, m);
}

int UVMSC_BOOST_REGEX_CALL c_regex_traits<unsigned short>::value(unsigned short c, int radix)
{
