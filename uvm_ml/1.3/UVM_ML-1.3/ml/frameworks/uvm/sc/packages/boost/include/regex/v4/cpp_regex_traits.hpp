...
#define UVMSC_BOOST_CPP_REGEX_TRAITS_HPP_INCLUDED
...
#ifndef UVMSC_BOOST_NO_STD_MESSAGES
...
std::locale cpp_regex_traits_base<charT>::imbue(const std::locale& l)
{
   ...
   m_locale = l;
   m_pctype = &UVMSC_BOOST_USE_FACET(std::ctype<charT>, l);
#ifndef UVMSC_BOOST_NO_STD_MESSAGES
   m_pmessages = UVMSC_BOOST_HAS_FACET(std::messages<charT>, l) ? &UVMSC_BOOST_USE_FACET(std::messages<charT>, l) : 0;
#endif
   m_pcollate = &UVMSC_BOOST_USE_FACET(std::collate<charT>, l);
   return result;
}
...
void cpp_regex_traits_char_layer<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
#ifndef UVMSC_BOOST_NO_EXCEPTIONS
      try{
#endif
...
//
template <>
class UVMSC_BOOST_REGEX_DECL cpp_regex_traits_char_layer<char> : public cpp_regex_traits_base<char>
{
...
#ifndef UVMSC_BOOST_REGEX_BUGGY_CTYPE_FACET
   UVMSC_BOOST_STATIC_CONSTANT(char_class_type, mask_blank = 1u << 24);
   UVMSC_BOOST_STATIC_CONSTANT(char_class_type, mask_word = 1u << 25);
   UVMSC_BOOST_STATIC_CONSTANT(char_class_type, mask_unicode = 1u << 26);
   UVMSC_BOOST_STATIC_CONSTANT(char_class_type, mask_horizontal = 1u << 27);
   UVMSC_BOOST_STATIC_CONSTANT(char_class_type, mask_vertical = 1u << 28);
#endif
   ...
   cpp_regex_traits_implementation<charT>::transform(const charT* p1, const charT* p2) const
{
   ...
   try{
...
#if UVMSC_BOOST_WORKAROUND(__BORLANDC__, < 0x580)
      ...
      while(result.size() && (charT(0) == *result.rbegin()))
         result.erase(result.size() - 1);
#endif
      UVMSC_BOOST_ASSERT(std::find(result.begin(), result.end(), charT(0)) == result.end());
#ifndef UVMSC_BOOST_NO_EXCEPTIONS
   }
   catch(...)
   {
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::uvmsc_boost::re_detail::char_class_alnum,
         ::uvmsc_boost::re_detail::char_class_alpha,
         ::uvmsc_boost::re_detail::char_class_cntrl,
         ::uvmsc_boost::re_detail::char_class_digit,
         ::uvmsc_boost::re_detail::char_class_graph,
         ::uvmsc_boost::re_detail::char_class_horizontal_space,
         ::uvmsc_boost::re_detail::char_class_lower,
         ::uvmsc_boost::re_detail::char_class_print,
         ::uvmsc_boost::re_detail::char_class_punct,
         ::uvmsc_boost::re_detail::char_class_space,
         ::uvmsc_boost::re_detail::char_class_upper,
         ::uvmsc_boost::re_detail::char_class_vertical_space,
         ::uvmsc_boost::re_detail::char_class_xdigit,
         ::uvmsc_boost::re_detail::char_class_blank,
         ::uvmsc_boost::re_detail::char_class_word,
         ::uvmsc_boost::re_detail::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::uvmsc_boost::re_detail::char_class_upper,
      ::uvmsc_boost::re_detail::char_class_vertical_space,
      ::uvmsc_boost::re_detail::char_class_alnum | ::uvmsc_boost::re_detail::char_class_word, 
      ::uvmsc_boost::re_detail::char_class_alnum | ::uvmsc_boost::re_detail::char_class_word, 
      ::uvmsc_boost::re_detail::char_class_xdigit,
   };
#endif
   ...
   UVMSC_BOOST_ASSERT(state_id < sizeof(masks) / sizeof(masks[0]));
...
{
   return
      ((mask & ::uvmsc_boost::re_detail::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::uvmsc_boost::re_detail::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::uvmsc_boost::re_detail::is_separator(c))
      || ((mask & ::uvmsc_boost::re_detail::char_class_word) && (c == '_'))
      || ((mask & ::uvmsc_boost::re_detail::char_class_unicode) && ::uvmsc_boost::re_detail::is_extended(c))
      || ((mask & ::uvmsc_boost::re_detail::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::uvmsc_boost::re_detail::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline uvmsc_boost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l UVMSC_BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(charT))
{
   cpp_regex_traits_base<charT> key(l);
   return ::uvmsc_boost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
private:
   uvmsc_boost::shared_ptr<const re_detail::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
...
int cpp_regex_traits<charT>::toi(const charT*& first, const charT* last, int radix)const
{
   ...
   last = std::find(first, last, UVMSC_BOOST_USE_FACET(std::numpunct<charT>, is.getloc()).thousands_sep());
