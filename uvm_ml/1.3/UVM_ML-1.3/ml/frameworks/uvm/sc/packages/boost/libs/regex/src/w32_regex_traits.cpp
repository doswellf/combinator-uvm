...
#ifdef UVMSC_BOOST_NO_STDC_NAMESPACE
namespace std{
   using ::memset;
}
#endif
...
#ifdef UVMSC_BOOST_NO_ANSI_APIS
...
void w32_regex_traits_char_layer<char>::init() 
{
   ...
   if(cat)
   {
      ...
      {
         string_type mss = ::uvmsc_boost::re_detail::w32_cat_get(cat, this->m_locale, i, get_default_syntax(i));
   ...
   do
   {
      if(m_char_map[i] == 0)
      {
         if(::uvmsc_boost::re_detail::w32_is(this->m_locale, 0x0002u, (char)i)) 
            m_char_map[i] = regex_constants::escape_type_class;
         else if(::uvmsc_boost::re_detail::w32_is(this->m_locale, 0x0001u, (char)i)) 
...
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is_lower(char c, lcid_type idx)
{
#ifndef UVMSC_BOOST_NO_ANSI_APIS
   WORD mask;
...
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is_lower(wchar_t c, lcid_type idx)
{
   WORD mask;
...
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is_lower(unsigned short ca, lcid_type idx)
{
   WORD mask;
   wchar_t c = ca;
   if(::GetStringTypeExW(idx, CT_CTYPE1, &c, 1, &mask) && (mask & C1_LOWER))
...
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is_upper(char c, lcid_type idx)
{
#ifndef UVMSC_BOOST_NO_ANSI_APIS
   WORD mask;
...
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is_upper(wchar_t c, lcid_type idx)
{
   WORD mask;
...
#ifdef UVMSC_BOOST_REGEX_HAS_OTHER_WCHAR_T
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is_upper(unsigned short ca, lcid_type idx)
{
   WORD mask;
   wchar_t c = ca;
   if(::GetStringTypeExW(idx, CT_CTYPE1, &c, 1, &mask) && (mask & C1_UPPER))
...
UVMSC_BOOST_REGEX_DECL std::string UVMSC_BOOST_REGEX_CALL w32_cat_get(const cat_type& cat, lcid_type, int i, const std::string& def)
{
#ifndef UVMSC_BOOST_NO_ANSI_APIS
   char buf[256];
   if(0 == ::LoadStringA(
...
UVMSC_BOOST_REGEX_DECL std::wstring UVMSC_BOOST_REGEX_CALL w32_cat_get(const cat_type& cat, lcid_type, int i, const std::wstring& def)
{
   wchar_t buf[256];
   if(0 == ::LoadStringW(
      static_cast<HMODULE>(cat.get()),
...
#endif
#endif
UVMSC_BOOST_REGEX_DECL std::string UVMSC_BOOST_REGEX_CALL w32_transform(lcid_type idx, const char* p1, const char* p2)
{
#ifndef UVMSC_BOOST_NO_ANSI_APIS
...
#ifndef UVMSC_BOOST_NO_WREGEX
UVMSC_BOOST_REGEX_DECL std::wstring UVMSC_BOOST_REGEX_CALL w32_transform(lcid_type idx, const wchar_t* p1, const wchar_t* p2)
{
   int bytes = ::LCMapStringW(
      idx,       // locale identifier
      LCMAP_SORTKEY,  // mapping transformation type
...
#ifdef UVMSC_BOOST_REGEX_HAS_OTHER_WCHAR_T
UVMSC_BOOST_REGEX_DECL std::basic_string<unsigned short> UVMSC_BOOST_REGEX_CALL w32_transform(lcid_type idx, const unsigned short* p1, const unsigned short* p2)
{
   int bytes = ::LCMapStringW(
      idx,       // locale identifier
      LCMAP_SORTKEY,  // mapping transformation type
...
#endif
#endif
UVMSC_BOOST_REGEX_DECL char UVMSC_BOOST_REGEX_CALL w32_tolower(char c, lcid_type idx)
{
   char result[2];
#ifndef UVMSC_BOOST_NO_ANSI_APIS
   int b = ::LCMapStringA(
...
#ifndef UVMSC_BOOST_NO_WREGEX
UVMSC_BOOST_REGEX_DECL wchar_t UVMSC_BOOST_REGEX_CALL w32_tolower(wchar_t c, lcid_type idx)
{
   wchar_t result[2];
   int b = ::LCMapStringW(
      idx,       // locale identifier
...
#ifdef UVMSC_BOOST_REGEX_HAS_OTHER_WCHAR_T
UVMSC_BOOST_REGEX_DECL unsigned short UVMSC_BOOST_REGEX_CALL w32_tolower(unsigned short c, lcid_type idx)
{
   wchar_t result[2];
   int b = ::LCMapStringW(
      idx,       // locale identifier
...
#endif
#endif
UVMSC_BOOST_REGEX_DECL char UVMSC_BOOST_REGEX_CALL w32_toupper(char c, lcid_type idx)
{
   char result[2];
#ifndef UVMSC_BOOST_NO_ANSI_APIS
   int b = ::LCMapStringA(
...
#ifndef UVMSC_BOOST_NO_WREGEX
UVMSC_BOOST_REGEX_DECL wchar_t UVMSC_BOOST_REGEX_CALL w32_toupper(wchar_t c, lcid_type idx)
{
   wchar_t result[2];
   int b = ::LCMapStringW(
      idx,       // locale identifier
...
#ifdef UVMSC_BOOST_REGEX_HAS_OTHER_WCHAR_T
UVMSC_BOOST_REGEX_DECL unsigned short UVMSC_BOOST_REGEX_CALL w32_toupper(unsigned short c, lcid_type idx)
{
   wchar_t result[2];
   int b = ::LCMapStringW(
      idx,       // locale identifier
...
#endif
#endif
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is(lcid_type idx, uvmsc_boost::uint32_t m, char c)
{
   WORD mask;
#ifndef UVMSC_BOOST_NO_ANSI_APIS
...
#ifndef UVMSC_BOOST_NO_WREGEX
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is(lcid_type idx, uvmsc_boost::uint32_t m, wchar_t c)
{
   WORD mask;
...
#ifdef UVMSC_BOOST_REGEX_HAS_OTHER_WCHAR_T
UVMSC_BOOST_REGEX_DECL bool UVMSC_BOOST_REGEX_CALL w32_is(lcid_type idx, uvmsc_boost::uint32_t m, unsigned short c)
{
   WORD mask;
