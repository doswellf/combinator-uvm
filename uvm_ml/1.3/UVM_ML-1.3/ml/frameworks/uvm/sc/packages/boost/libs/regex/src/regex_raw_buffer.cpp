...
void UVMSC_BOOST_REGEX_CALL raw_storage::resize(size_type n)
{
   ...
   UVMSC_BOOST_REGEX_NOEH_ASSERT(ptr)
...
void* UVMSC_BOOST_REGEX_CALL raw_storage::insert(size_type pos, size_type n)
{
   UVMSC_BOOST_ASSERT(pos <= size_type(end - start));
