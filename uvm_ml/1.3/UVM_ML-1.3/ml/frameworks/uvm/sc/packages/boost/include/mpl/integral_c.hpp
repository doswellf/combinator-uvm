...
#ifndef UVMSC_BOOST_MPL_INTEGRAL_C_HPP_INCLUDED
#define UVMSC_BOOST_MPL_INTEGRAL_C_HPP_INCLUDED
...
#include <packages/boost/include/mpl/integral_c_fwd.hpp>
...
#if UVMSC_BOOST_WORKAROUND(__HP_aCC, <= 53800)
...
#include <packages/boost/include/mpl/aux_/integral_wrapper.hpp>


#if !defined(UVMSC_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) \
 && !UVMSC_BOOST_WORKAROUND(__BORLANDC__, <= 0x551)
...
#endif // UVMSC_BOOST_MPL_INTEGRAL_C_HPP_INCLUDED
