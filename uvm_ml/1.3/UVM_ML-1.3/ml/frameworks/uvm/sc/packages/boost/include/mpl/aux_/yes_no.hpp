...
#ifndef UVMSC_BOOST_MPL_AUX_YES_NO_HPP_INCLUDED
#define UVMSC_BOOST_MPL_AUX_YES_NO_HPP_INCLUDED
...
#include <packages/boost/include/mpl/aux_/config/arrays.hpp>
...
template< UVMSC_BOOST_MPL_AUX_NTTP_DECL(long, n) > struct weighted_tag
{
...
#endif // UVMSC_BOOST_MPL_AUX_YES_NO_HPP_INCLUDED
