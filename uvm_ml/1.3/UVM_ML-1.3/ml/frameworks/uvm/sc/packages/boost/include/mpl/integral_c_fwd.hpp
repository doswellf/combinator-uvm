...
#ifndef UVMSC_BOOST_MPL_INTEGRAL_C_FWD_HPP_INCLUDED
#define UVMSC_BOOST_MPL_INTEGRAL_C_FWD_HPP_INCLUDED
...
UVMSC_BOOST_MPL_AUX_ADL_BARRIER_DECL(integral_c)

#endif // UVMSC_BOOST_MPL_INTEGRAL_C_FWD_HPP_INCLUDED
