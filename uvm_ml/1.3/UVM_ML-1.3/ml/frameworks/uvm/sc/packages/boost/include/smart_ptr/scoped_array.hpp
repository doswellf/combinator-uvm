#ifndef UVMSC_BOOST_SMART_PTR_SCOPED_ARRAY_HPP_INCLUDED
#define UVMSC_BOOST_SMART_PTR_SCOPED_ARRAY_HPP_INCLUDED
...
#include <packages/boost/include/config.hpp>   // in case ptrdiff_t not in std
...
public:
    ...
    {
#if defined(UVMSC_BOOST_SP_ENABLE_DEBUG_HOOKS)
        uvmsc_boost::sp_array_constructor_hook( px );
#endif
    }
    ...
    {
#if defined(UVMSC_BOOST_SP_ENABLE_DEBUG_HOOKS)
        uvmsc_boost::sp_array_destructor_hook( px );
#endif
        uvmsc_boost::checked_array_delete( px );
    }
...
#endif  // #ifndef UVMSC_BOOST_SMART_PTR_SCOPED_ARRAY_HPP_INCLUDED
