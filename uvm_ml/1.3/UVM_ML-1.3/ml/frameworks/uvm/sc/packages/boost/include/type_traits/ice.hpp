...
#ifndef UVMSC_BOOST_TT_ICE_HPP_INCLUDED
#define UVMSC_BOOST_TT_ICE_HPP_INCLUDED
...
#include <packages/boost/include/type_traits/detail/ice_eq.hpp>

#endif // UVMSC_BOOST_TT_ICE_HPP_INCLUDED
