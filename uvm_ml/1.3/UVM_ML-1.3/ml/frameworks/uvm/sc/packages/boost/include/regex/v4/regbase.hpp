...
#define UVMSC_BOOST_REGEX_V4_REGBASE_HPP
...
//
class UVMSC_BOOST_REGEX_DECL regbase
{
public:
   enum flag_type_
   {
...
namespace regex_constants{
   ...
   enum flag_type_
   {
      ...
      no_except = ::uvmsc_boost::regbase::no_except,
      failbit = ::uvmsc_boost::regbase::failbit,
      literal = ::uvmsc_boost::regbase::literal,
      icase = ::uvmsc_boost::regbase::icase,
      nocollate = ::uvmsc_boost::regbase::nocollate,
      collate = ::uvmsc_boost::regbase::collate,
      nosubs = ::uvmsc_boost::regbase::nosubs,
      optimize = ::uvmsc_boost::regbase::optimize,
      bk_plus_qm = ::uvmsc_boost::regbase::bk_plus_qm,
      bk_vbar = ::uvmsc_boost::regbase::bk_vbar,
      no_intervals = ::uvmsc_boost::regbase::no_intervals,
      no_char_classes = ::uvmsc_boost::regbase::no_char_classes,
      no_escape_in_lists = ::uvmsc_boost::regbase::no_escape_in_lists,
      no_mod_m = ::uvmsc_boost::regbase::no_mod_m,
      mod_x = ::uvmsc_boost::regbase::mod_x,
      mod_s = ::uvmsc_boost::regbase::mod_s,
      no_mod_s = ::uvmsc_boost::regbase::no_mod_s,
      save_subexpression_location = ::uvmsc_boost::regbase::save_subexpression_location,
      no_empty_expressions = ::uvmsc_boost::regbase::no_empty_expressions,

      basic = ::uvmsc_boost::regbase::basic,
      extended = ::uvmsc_boost::regbase::extended,
      normal = ::uvmsc_boost::regbase::normal,
      emacs = ::uvmsc_boost::regbase::emacs,
      awk = ::uvmsc_boost::regbase::awk,
      grep = ::uvmsc_boost::regbase::grep,
      egrep = ::uvmsc_boost::regbase::egrep,
      sed = basic,
      perl = normal,
      ECMAScript = normal,
      JavaScript = normal,
   ...
   typedef ::uvmsc_boost::regbase::flag_type syntax_option_type;
