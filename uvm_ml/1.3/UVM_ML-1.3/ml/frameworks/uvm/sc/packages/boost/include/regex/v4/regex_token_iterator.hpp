...
#ifndef UVMSC_BOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP
#define UVMSC_BOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP

#include <packages/boost/include/shared_ptr.hpp>
#include <packages/boost/include/detail/workaround.hpp>
#if (UVMSC_BOOST_WORKAROUND(__BORLANDC__, >= 0x560) && UVMSC_BOOST_WORKAROUND(__BORLANDC__, UVMSC_BOOST_TESTED_AT(0x570)))\
      || UVMSC_BOOST_WORKAROUND(UVMSC_BOOST_MSVC, < 1300) \
      || UVMSC_BOOST_WORKAROUND(__MWERKS__, UVMSC_BOOST_TESTED_AT(0x3003))
//
...
public:
      ...
      : end(last), re(*p), flags(f)
   {
      ...
      UVMSC_BOOST_STATIC_ASSERT(::uvmsc_boost::is_array<T>::value);
...
template <class BidirectionalIterator, 
          class charT = UVMSC_BOOST_DEDUCED_TYPENAME re_detail::regex_iterator_traits<BidirectionalIterator>::value_type,
...
#endif // UVMSC_BOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP
