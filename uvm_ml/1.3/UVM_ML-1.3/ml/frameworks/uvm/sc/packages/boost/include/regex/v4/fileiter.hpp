...
#ifndef UVMSC_BOOST_RE_FILEITER_HPP_INCLUDED
#define UVMSC_BOOST_RE_FILEITER_HPP_INCLUDED
...
#ifndef UVMSC_BOOST_REGEX_NO_FILEITER

#if (defined(__CYGWIN__) || defined(__CYGWIN32__)) && !defined(UVMSC_BOOST_REGEX_NO_W32)
#error "Sorry, can't mix <windows.h> with STL code and gcc compiler: if you ran configure, try again with configure --disable-ms-windows"
#define UVMSC_BOOST_REGEX_FI_WIN32_MAP
#define UVMSC_BOOST_REGEX_FI_POSIX_DIR
#elif (defined(__WIN32__) || defined(_WIN32) || defined(WIN32)) && !defined(UVMSC_BOOST_REGEX_NO_W32)
#define UVMSC_BOOST_REGEX_FI_WIN32_MAP
#define UVMSC_BOOST_REGEX_FI_WIN32_DIR
#else
#define UVMSC_BOOST_REGEX_FI_POSIX_MAP
#define UVMSC_BOOST_REGEX_FI_POSIX_DIR
#endif

#if defined(UVMSC_BOOST_REGEX_FI_WIN32_MAP)||defined(UVMSC_BOOST_REGEX_FI_WIN32_DIR)
#include <windows.h>
#endif

#if defined(UVMSC_BOOST_REGEX_FI_WIN32_DIR)
...
#elif defined(UVMSC_BOOST_REGEX_FI_POSIX_DIR)
...
#ifdef UVMSC_BOOST_REGEX_FI_WIN32_MAP // win32 mapfile

class UVMSC_BOOST_REGEX_DECL mapfile
{
   HANDLE hfile;
   HANDLE hmap;
   const char* _first;
...
class UVMSC_BOOST_REGEX_DECL mapfile_iterator;
...
class UVMSC_BOOST_REGEX_DECL mapfile_iterator
#if !defined(UVMSC_BOOST_NO_STD_ITERATOR) || defined(UVMSC_BOOST_MSVC_STD_ITERATOR)
...
public:
   ...
   char operator* ()const
   {
      UVMSC_BOOST_ASSERT(node >= file->_first);
      UVMSC_BOOST_ASSERT(node < file->_last);
...
UVMSC_BOOST_REGEX_DECL extern const char* _fi_sep;
...
class UVMSC_BOOST_REGEX_DECL file_iterator 
{
   char* _root;
   char* _path;
   char* ptr;
...
class UVMSC_BOOST_REGEX_DECL directory_iterator
{
   char* _root;
   char* _path;
   char* ptr;
...
using uvmsc_boost::re_detail::directory_iterator;
using uvmsc_boost::re_detail::file_iterator;
using uvmsc_boost::re_detail::mapfile;
} // namespace uvmsc_boost

#endif     // UVMSC_BOOST_REGEX_NO_FILEITER
#endif     // UVMSC_BOOST_RE_FILEITER_HPP
