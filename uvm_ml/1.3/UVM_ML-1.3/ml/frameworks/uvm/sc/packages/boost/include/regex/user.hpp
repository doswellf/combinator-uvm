...
// want UVMSC_BOOST_REGEX_DYN_LINK to set up dll exports/imports
// with __declspec(dllexport)/__declspec(dllimport.)
// #define UVMSC_BOOST_REGEX_HAS_DLL_RUNTIME

// define this if you want to dynamically link to regex,
// if the runtime library is also a dll (Probably Win32 specific,
// and has no effect unless UVMSC_BOOST_REGEX_HAS_DLL_RUNTIME is set):
// #define UVMSC_BOOST_REGEX_DYN_LINK
...
// #define UVMSC_BOOST_REGEX_NO_FWD
...
// even if UVMSC_BOOST_REGEX_HAS_MS_STACK_GUARD is not defined.
