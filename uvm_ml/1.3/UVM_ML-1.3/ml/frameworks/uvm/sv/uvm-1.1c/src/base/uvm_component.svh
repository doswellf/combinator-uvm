...
typedef uvm_extended_singular_config_db#(uvm_bitstream_t) uvm_config_int;
typedef uvm_extended_string_config_db                              uvm_config_string; // Temporary till some simulators do not support dynamic cast of strings
typedef uvm_extended_singular_config_db#(uvm_object)      uvm_config_object;
//--------------------
// ML Additions (END)
//--------------------
