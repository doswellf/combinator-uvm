...
function uvm_phase uvm_root::get_phase_by_name(string phase_name);
  ...
  case(phase_name)
    ...
    "run": ret_val = run_ph; 
    "extract": ret_val = extract_ph; 
    "check": ret_val = check_ph; 
    "report": ret_val = report_ph; 
    "final": ret_val = final_ph; 
    "reset": ret_val = domain.find_by_name(phase_name);
    "configure": ret_val = domain.find_by_name(phase_name);
    "main": ret_val = domain.find_by_name(phase_name);
    "shutdown": ret_val = domain.find_by_name(phase_name);
    default: begin
               ret_val = null;
